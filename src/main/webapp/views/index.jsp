...
<head>
    ...
    <title>AADHARANA FOUNDATIONS</title>
        ...
        <div class="container">
            <div class="row col-det">
                ...
                <div class="col-lg-3 d-none d-md-block col-md-6 btn-bhed">
                    <button class="btn btn-sm btn-success" onclick="document.location='/register'">Join Us</button>
                    <button class="btn btn-sm btn-default" onclick= "document.location='/login'">Donate</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row nav-row">
                <div class="col-lg-3 col-md-12 logo">
                    <a href="index.html">
                        <img src="assets/images/aflogo.png" alt="">
                ...
                <div id="menu" class="col-lg-9 col-md-12 d-none d-lg-block nav-col">
                            ...
                            <ul class="navbad">
                                <li class="nav-item active">
                                    <a class="nav-link" onclick="document.location='/index'">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="document.location='/abt'">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="document.location='/service'">Services</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" onclick="document.location='/gallery'">Gallery</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" onclick="document.location='/blog'">Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="document.location='/contact'">Contact US</a>
                                </li>
            ...
            <div class="event-ro row">
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        ...
                        <button class="btn btn-success btn-sm" onclick="document.location='/login'">Donate Now</button>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
    ...
    <!--################### Our Team Starts Here #######################--->
          <section class="our-team team-11">
            <div class="container">
                ...
                <div class="row team-row" align="center">
            ...
            <div class="nav-box row clearfix">
                <div class="inner col-md-9 clearfix">
                    <ul class="footer-nav clearfix">
                        ...
                        <li><u><a href="/Superlogin">ARE YOU THE ADMIN??</a></u></li>
                        <br><br><br>
                        <li><u><a href="/NgoLogin">WANNA COLLABORATE FOR NGO??</a></u></li>
