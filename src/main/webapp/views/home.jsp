        ...
        <div class="container">
            <div class="row col-det">
                <div class="col-lg-6 d-none d-lg-block">
                    <ul class="ulleft">
                        <li>
                            ...
                            aadharanafoundations@gmail.com
                            <span>|</span></li>
                        <li>
                ...
                <div class="col-lg-3 d-none d-md-block col-md-6 btn-bhed">
                    <button class="btn btn-sm btn-success" ><span><a href="/donationform">Donate</a></span></button>
                    <button class="btn btn-sm btn-default"><span><a href="/userlogout">Logout</a></span></button>
